        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header with-border">
              <a href="#addnew" data-toggle="modal" class="btn btn-primary btn-sm btn-flat"><i class="fa fa-plus"></i> Nou</a>
            </div>
            <div class="box-body">
                  ...
                  <?php
                    ...
                    try{
                      ...
                      foreach($stmt as $row){
                        ...
                        $status = ($row['status']) ? '<span class="label label-success">cont activ</span>' : '<span class="label label-danger">neverificat</span>';
                        ...
                        echo "
                          <tr>
                            ...
                            <td>
                              <a href='cart.php?user=".$row['id']."' class='btn btn-info btn-sm btn-flat'><i class='fa fa-search'></i> Cos</a>
